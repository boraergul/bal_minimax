...
| 4 | `teslimat_adresi` | TEXT | Eklendi | Müşterinin ürün teslimat adresi |
...
| 7 | `minimum_stok_seviyesi` | DECIMAL(15,3) | Eklenmeli | Minimum stok uyarı seviyesi |
...
| 11 | `giris_referans_no` | VARCHAR(100) | Eklendi | Tedarikçi irsaliyesi veya harici teslimat belgesi referansı |
...
| # | Eksik Alan | Veri Tipi | Öneri | Gerekçe |
|---|------------|-----------|-------|---------|
| 1 | `teslimat_adresi` | TEXT | Eklendi | Müşterinin ürün teslimat adresi |
| 2 | Ödeme alanları | — | Kapsam dışı | Ödeme ve vade takibi harici sistemdedir |
| 3 | Mali belge alanları | — | Kapsam dışı | Faturalama ve vergi belgeleri bu ERP'de tutulmaz |
...
| 6 | `two_factor_active` | BOOLEAN | Eklenmeli | İki faktörlü doğrulama aktif mi? |
| 7 | `two_factor_secret` | VARCHAR(255) | Eklenmeli | TOTP secret (şifrelenmiş) |
...
| 4 | `SKT_UYARI_GUN` | INTEGER | Eklendi | Son kullanma uyarısı kaç gün önce; `sistem_ayarlari.ayar_adi` kanonik anahtarı |
| 5 | `kalite_kontrol_zorunlu` | BOOLEAN | Eklenmeli | Stok girişinde kalite kontrol zorunlu mu? |
| 6 | Mali belge zorunluluğu | — | Kapsam dışı | Stok girişinde yalnız irsaliye/harici teslimat referansı opsiyoneldir |
